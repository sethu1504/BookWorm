...
def wiki_description_crawler(book_titles):
    ...
    for i in book_titles:
        ...
        description = ''
        try:
            i = i.split("(", 1)[0]  # remove series content and brackets
            google_url = 'https://www.google.com/'
            browser.get(google_url)
...
def readgeek_description_crawler(isbns):
    ...
    for i in isbns:
        ...
        readgeek_query_url = 'https://www.readgeek.com/search/search?q=' + i
...
main_desc_df = pd.read_csv('../data//description.csv',
                           encoding='utf-8')  # '/Users/reet/PycharmProjects/BookWorm/data/books.csv')
...
main_desc_df = pd.read_csv('/Users/reet/Documents/Jupyter/Big Data2/Data Files/description.csv',
                           encoding='utf-8')  # '/Users/reet/PycharmProjects/BookWorm/data/books.csv')
main_desc_df.head(5)
